...
**Cite**: Knolle, F., Sterner, E. F., Demler, V. F., MacGregor, L. J., & Mathys, C. (2025). Guided by expectations: overweighted semantic priors in schizotypy and their links to glutamate. Biological Psychiatry. https://doi.org/10.1016/j.biopsych.2025.06.025
...
- an empty `data/` folder at the repository root (where the outputs will be saved)
### Run the modelling
...
# **Author**: Polina Yarko
This repository was prepared and maintained by Polina Yarko.
